 ...
 * component re-binds the {@code cacherelay.sse.flush} prefix from the {@link Environment} on a schedule (default 30s,
 * overridable with {@code cacherelay.sse.flush.reload-interval}) and pushes changed, valid snapshots into the strategy
...
public class SseFlushConfigReloader {
	...
	private static final String PREFIX = "cacherelay.sse.flush";
	 ...
	 */
	@Scheduled(fixedDelayString = "${cacherelay.sse.flush.reload-interval:30s}")
	void reload() {

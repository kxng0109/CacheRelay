package io.github.kxng0109.cacherelay.security.guardrail.injection;
...
public class PromptInjectionException extends RuntimeException {
	...
	private static final URI PROBLEM_TYPE = URI.create("https://cacherelay.io/errors/prompt-injection-detected");

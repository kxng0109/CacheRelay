...
@DisplayName("CacheRelayCacheService")
class CacheRelayCacheServiceTest {
	...
	void initAndPurge() {
		...
		CacheRelayCacheService nullRegistryService = new CacheRelayCacheService(
	...
	void evaluateCacheEdgeCases() throws Exception {
		...
		CacheRelayCacheService faultyMeterService = new CacheRelayCacheService(

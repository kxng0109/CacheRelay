...
import io.github.kxng0109.cacherelay.proxy.sse.DefaultSseLineGuard;
...
class ProxyControllerGuardrailStreamingTest {
	...
	void decoratesHeadersWithAuditReceiptAndZdr() {
		...
		assertThat(response.getHeaders().getFirst("X-CacheRelay-Audit-Receipt")).isNotNull().hasSize(50);

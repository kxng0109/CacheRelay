package io.github.kxng0109.cacherelay.security.guardrail.streaming;
...
public final class MidStreamKillSwitch {
	...
	private static final String DEFAULT_TERMINATION_EVENT =
			"event: error\n"
					+ "data: {\"error\":{\"message\":\"Stream terminated by CacheRelay guardrail: content policy violation\",\"type\":\"guardrail_violation\",\"code\":\"content_filter\",\"param\":null}}\n\n";

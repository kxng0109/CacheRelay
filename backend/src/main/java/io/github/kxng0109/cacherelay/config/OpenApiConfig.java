...
/**
 * OpenAPI 3.1 and Swagger UI configuration for CacheRelay AI Gateway. Configures global metadata, security schemes for
...
public class OpenApiConfig {
	 ...
	 */
	@Bean
	public OpenAPI cacheRelayOpenAPI() {
		return new OpenAPI()
				.openapi("3.1.0")
				.info(new Info()
						      .title("CacheRelay AI Gateway & Resilient Reverse Proxy")
						      .version("1.7.0")
						      .summary(
								      "Enterprise-grade AI proxy gateway with rate limiting, multi-tier caching, universal tool calling, and failover")
						      .description("""
								                   **CacheRelay** is a high-performance, resilient AI reverse proxy gateway engineered in Java 25 & Spring Boot 4.1.
								                   ...
								                   * **Asynchronous Usage Ledger**: Exact micro-dollar precision accounting and PostgreSQL 16+ covering-index analytical aggregations.
								                   """)
						      .contact(new Contact()
								               .name("CacheRelay Systems & Security Engineering")
								               .url("https://github.com/kxng0109/CacheRelay")
								               .email("security@cacherelay.internal"))
						      .license(new License()
								               .name("Apache 2.0")
				...
				.servers(List.of(
						...
						new Server()
								.url("https://gateway.cacherelay.io")
				...
				.components(new Components()
						            ...
						            .addSecuritySchemes(
								            SCHEME_BEARER_AUTH, new SecurityScheme()
										            ...
										            .scheme("bearer")
										            .bearerFormat("gw-* (CacheRelay Key)")
										            .description("""
